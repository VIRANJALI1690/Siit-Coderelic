            ...
            <div className="flex items-center gap-6 flex-1">
              ...
              {isAuthenticated && (
                <form
                  ...
                  className="relative w-full max-w-md hidden sm:block group"
                >
            ...
            <div className="flex items-center gap-2 ml-6">
              ...
              {isAuthenticated ? (
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      ...
                      <ChevronDown
                        size={14}
                        className={`text-slate-500 transition-transform ${isSettingsOpen ? "rotate-180" : ""}`}
                      />
                    </button>
                      ...
                      <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-slate-900 rounded-xl shadow-xl border border-slate-200 dark:border-slate-800 py-2 z-50">
                        ...
                        <div className="p-1">
                          ...
                          <Link
                            ...
                            className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-700 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-600"
                          >
                          ...
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-slate-700 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-600"
                          >
                          ...
                          <button
                            ...
                            className="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 font-bold"
                          >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Link
                    to="/register"
                    className="px-4 py-2 text-sm font-medium rounded-lg text-white bg-[#4F46E5] hover:bg-indigo-700 transition-colors"
                  >
                    Sign Up
                  </Link>
        ...
        {isMobileMenuOpen && isAuthenticated && (
          <div className="lg:hidden bg-white dark:bg-[#0B1120] border-t border-slate-100 dark:border-slate-800 px-4 py-4 space-y-2">
            ...
            <Link
              ...
              className="block px-3 py-2 rounded-lg text-base font-bold text-slate-600 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-600"
            >
              Publish Project
            </Link>
